...
<body>
    ...
    <div>
        <ul class="list">
            <li><a href="./currentprograms">Current programs</a></li>
            <li><a href="./viewparticipants">View participants</a></li>
            <li><a href="./newprogramadmin">Add new programs</a></li>
            <li><a href="./viewclub">View clubs</a></li>
            <li><a href="./newclub">Add new clubs</a></li>
            <li><a href="./newadmin">Add new admin</a></li>
            <li id="changepass"><a href="#">Change password</a></li>
            <li><a href="./deleteadmin">Delete account</a></li>
        </ul>
    </div>
