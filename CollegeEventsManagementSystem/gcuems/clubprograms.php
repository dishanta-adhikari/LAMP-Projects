...
if (isset($_POST['delete_program_id'])) {
    ...
    $delete_query = "DELETE program, participant 
                 FROM program 
                 INNER JOIN participant ON program.program_id = participant.program_id 
    ...
    if ($stmt) {
        ...
        if ($delete_result) {
            ...
            echo '<script>window.location.href = "./clubprograms.php";</script>';
            exit;
        } else {
