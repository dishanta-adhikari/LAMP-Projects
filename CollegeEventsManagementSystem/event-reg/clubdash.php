...
<body>
    ...
    <div>
        <ul class="list">
            <li><a href="./clubprograms">My programs</a></li>
            <li><a href="./clubwiseprtcpnt">View Participants</a></li>
            <li><a href="./newprogramclub">Add New programs</a></li>
            <li id="changepass"><a href="#">Change password</a></li>
            <li><a href="./deleteclub">Delete account</a></li>
        </ul>
    </div>
