...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check->num_rows > 0) {
        ...
        if ($conn->query($sql) === TRUE) {
            $message = "<div class='alert alert-success'>Registration successful. <a href='login_user'>Login Now</a></div>";
        } else {
...
<body class="bg-light">
    <div class="container mt-5 card shadow p-4">
        ...
        <form method="POST">
            ...
            <a href="login_user" class="btn btn-secondary">Back to Login</a>
        </form>
    </div>
</body>
